...
export const translations = {
  en: {
    ...
    totalCredibility: "Total credibility",
    ...
    timeOutsideTab: "Time spent outside the tab (seconds)",
    zoomOuts: "Number of map zoom-outs",
    zoomIns: "Number of map zoom-ins",
    drags: "Number of map drags",
  ...
  pl: {
    ...
    totalCredibility: "Całkowita wiarygodność",
    questionId: "Nr odpowiedzi",
    answer: "Odpowiedź",
    sum: "Suma",
    totalPoints: "Suma punktów respondentów",
    mean: "Średnia kategorii",
    avgPerQuestion: "Średnia punktów dla pytania i kategorii",
    avgPerAllQuestions: "Średnia punktów dla pytania",
    ...
    timeSpent: "Czas spędzony (sekundy)",
    attempts: "Ilość prób",
    timeOutsideTab: "Czas spędzony poza zakładką (sekundy)",
    zoomOuts: "Ilość oddaleń mapy",
    zoomIns: "Ilość przybliżeń mapy",
    drags: "Ilość przeciągnięć mapy",
